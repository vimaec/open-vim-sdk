...
namespace Vim.Math3d
{
    ...
    public partial struct Quaternion
    {
        ...
        {
            return new Quaternion((float)Math.Sin(theta * 0.5f), 0.0f, 0.0f, (float)Math.Cos(theta * 0.5f));
        }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Quaternion CreateYRotation(float theta)
        {
            return new Quaternion(0.0f, (float)Math.Sin(theta * 0.5f), 0.0f, (float)Math.Cos(theta * 0.5f));
        }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Quaternion CreateZRotation(float theta)
        {
            return new Quaternion(0.0f, 0.0f, (float)Math.Sin(theta * 0.5f), (float)Math.Cos(theta * 0.5f));
        }
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Quaternion CreateLookatRotation(Vector3 Position, Vector3 UpVector, Vector3 TargetPosition)
        {
            var forward = new Vector3(0.0f, 0.0f, -1.0f);
            var plane = Plane.CreateFromNormalAndPoint(UpVector, Position);
        ...
        /// <summary>
        /// Multiplies Quaternions with a Vector3, effectively rotating the vector by the quaternion.
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector3 operator *(Quaternion value1, Vector3 value2)
        {
            var q = new Quaternion(value2.X, value2.Y, value2.Z, 0.0f);
            Quaternion res = value1.Conjugate() * q * value1;
